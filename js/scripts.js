...
var celsius = parseFloat(prompt("Enter degrees in Celsius:"));

var result6 = tempConverter (celsius);
alert(result6);
...
var hight = parseFloat(prompt("Enter your hight:"));
var result5 = bmi (weight, hight);
alert(result5);
